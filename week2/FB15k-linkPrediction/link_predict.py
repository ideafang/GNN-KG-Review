...
def read_triplets_as_list(filename, entity_dict="./FB15k-237/entities.dict", relation_dict="./FB15k-237/relations.dict"):
...
def main(args):
    # load graph data
    nodes_dict = read_dictionary("./FB15k-237/entities.dict")
    rels_dict = read_dictionary("./FB15k-237/relations.dict")
    num_nodes = len(nodes_dict)
    train_data = np.array(read_triplets_as_list("./FB15k-237/train.txt"))
    valid_data = np.array(read_triplets_as_list("./FB15k-237/valid.txt"))
    test_data = np.array(read_triplets_as_list("./FB15k-237/test.txt"))
    num_rels = len(rels_dict)
